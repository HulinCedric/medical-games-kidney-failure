 ...
 * @author Cedric Hulin
 */
public class EcouteurFaisTonMarche implements MouseListener, MouseMotionListener {
	 ...
	 * @since 1.0.0
	 */
	public EcouteurFaisTonMarche(JFrame hamecon, FaisTonMarche jeu) {
	...
	public void mouseEntered(MouseEvent e) {
		...
		if (jeu.obtenirCheminImage() != null) {
			...
			//
			jeu.obtenirClavier().modifierTexteEcran(
					nomAliment + Texte.load("../_Textes/Jeux/FaisTonMarche/Question") + hamecon.getTitle() + " ?");
		} else
			// Afficher un message d'aide
			//
